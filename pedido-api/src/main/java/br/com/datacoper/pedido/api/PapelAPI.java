...
import br.com.datacoper.pedido.application.service.PapelService;
...
public class PapelAPI extends GumgaAPI<Papel, Long> {


    @Autowired
    public PapelAPI(GumgaService<Papel, Long> service) {
        super(service);
    }
